...
public class ad_hoc_teams_member {
    ...
    @PrimaryKeyJoinColumn(foreignKey = @ForeignKey(name = "INDIVIDUAL_AUTHORS_EMAIL"))
    ...
    @ManyToOne
    @JoinTable(name = "INDIVIDUAL_AUTHORS_EMAIL", joinColumns = @JoinColumn(name = "INDIVIDUAL_AUTHORS_EMAIL"),
